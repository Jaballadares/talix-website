...
<div class="w-section company-section-5" id="career">
    ...
    <iframe width="100%" height="1550" id="compframe" name="compframe" frameborder="0" scrolling="no" allowTransparency="true"> </iframe>

    <script>
      var compframe = document.getElementById('compframe');


    </script>

    </div>
<!-- <h1 style="color: black;">We currently do not have any openings, please check back later</h1> -->
